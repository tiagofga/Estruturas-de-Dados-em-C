...
| [Grafo](./Grafo) | [docs/Grafo.md](./docs/Grafo.md) | Grafo direcionado e não-direcionado com matriz de adjacência + BFS/DFS/Dijkstra/topológica | O(1) consulta de aresta |
