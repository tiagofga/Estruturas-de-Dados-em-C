...
| [Tabela Hash](./TabelaHash.md) | Tabela hash com encadeamento separado |
...
| [AVL](./AVL.md) | Árvore AVL com inserção, remoção, rotações e balanceamento automático |
| [Grafo](./Grafo.md) | Grafo direcionado/não-direcionado com matriz de adjacência + algoritmos de grafos |
| [Grafo por lista de adjacência](./GrafoListaAdjacencia.md) | Grafo esparso com BFS, DFS e Dijkstra |
| [Algoritmos avançados de grafos](./AlgoritmosGrafos.md) | Union-Find, Kruskal, Prim, Bellman-Ford e Floyd-Warshall |
