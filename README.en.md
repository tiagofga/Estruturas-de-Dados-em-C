...
Educational repository with implementations of data structures and algorithms in C, including fundamental and advanced structures, executable examples, automated tests, module-level documentation, and practical exercises.
...
| [HashTable](./TabelaHash) | [docs/en/HashTable.md](./docs/en/HashTable.md) | Hash table with separate chaining | O(1) average, O(n) worst case |
...
| [AVL](./AVL) | [docs/en/AVL.md](./docs/en/AVL.md) | AVL tree with insertion, removal, rotations, and automatic balancing | O(log n) search/insert/remove |
...
| [GraphAlgorithms](./AlgoritmosGrafos) | [docs/en/AdvancedGraphAlgorithms.md](./docs/en/AdvancedGraphAlgorithms.md) | Union-Find, Kruskal, Prim, Bellman-Ford, and Floyd-Warshall | O(E log E), O(VE), O(V³) |
...
| Module | Build | Tests | Sanitizer | PT docs | EN docs |
|--------|-------|-------|-----------|---------|---------|
| List/Queue/Stack | CI | CI | — | Yes | Yes |
| Heap | CI | CI | CI | Yes | Yes |
| HashTable | CI | CI | CI | Yes | Yes |
| Singly/Doubly linked lists | CI | CI | CI | Yes | Yes |
| Tree / AVL | CI | CI | AVL | Yes | Yes |
| Graph / AdjacencyListGraph | CI | CI | AdjacencyListGraph | Yes | Yes |
| GraphAlgorithms | CI | CI | CI | Yes | Yes |
| Search / Sorting | CI | CI | — | Yes | Yes |
...
Automated tests are organized in each module's `tests/` directory. The CI builds and tests all implemented modules, and also runs sanitizer tests for the new and advanced modules.
